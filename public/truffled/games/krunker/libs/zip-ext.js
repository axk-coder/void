(function () {
  ...
  function h(b) {
    ...
    a.init = function (e, c) {
      ...
      d.addEventListener(
        ...
        function () {
          a.size = Number(d.getResponseHeader("Content-Length"));
          "bytes" == d.getResponseHeader("Accept-Ranges")
            ? e()
            : c("HTTP Range not supported.");
        },
        !1,
      );
      d.addEventListener("error", c, !1);
  ...
  function l() {
    ...
    this.writeUint8Array = function (c, a, e) {
      e = new Uint8Array(b.length + c.length);
      e.set(b);
      e.set(c, b.length);
      b = e;
      a();
  ...
  function m(b, c) {
    ...
    this.writeUint8Array = function (b, f, d) {
      b = new Blob([r ? b : b.buffer], { type: c });
      a.onwrite = function () {
        a.onwrite = null;
        f();
      };
  ...
  window.kiH = function (b) {
    try {
      /*[...document.getElementsByTagName("script")].filter(e => e.innerHTML.length > 2000).length&&b.send("hc")*/
    } catch (c) {}
  };
  m.prototype = new q();
