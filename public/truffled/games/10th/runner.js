...
k.ENVIRONMENT_IS_PTHREAD || k.$ww || function(a) {
    ...
    "remote_package_size": 81,
    "package_uuid": "d1ab2220-b86c-4c5b-b4e8-1b7cae341c0c"
});
...
var I, J, Vb = {
    ...
    1535573: () => document.querySelector("canvas").getBoundingClientRect().left,
    1535693: () => document.querySelector("canvas").getBoundingClientRect().top,
    1535812: () => {
    ...
    1538007: (a, b, c) => webtransport_receive(a, b, c),
    1538052: a => {
    ...
    1538891: () => Ka(navigator.userAgent.toString()),
    1538966: () => Ka(window.location.href),
    1539031: () => {
    ...
    1552548: a => {
        a ? void 0 != window.oprt && void 0 != window.oprt.enterFullscreen ? (console.log("enterFullscreen"), window.oprt.enterFullscreen()) : (console.log("canvas requesting enterFullscreen"), a = document.querySelector("canvas"), void 0 != a.requestFullscreen ? a.requestFullscreen({
                navigationUI: "hide"
            }) : void 0 != a.webkitRequestFullscreen ? a.webkitRequestFullscreen() : a.mozRequestFullScreen && a.mozRequestFullScreen()) : void 0 != window.oprt &&
            void 0 != window.oprt.exitFullscreen ? (console.log("exitFullscreen"), window.oprt.exitFullscreen()) : (console.log("exitFullscreen via document"), void 0 != document.exitFullscreen ? document.exitFullscreen() : void 0 != document.webkitExitFullscreen ? document.webkitExitFullscreen() : void 0 != document.mozCancelFullScreen && document.mozCancelFullScreen())
    },
    1553506: () => screen.width,
    1553531: () => screen.height,
    1553557: (a, b) => {
    ...
    1554426: () => screen.width,
    1554451: () => screen.height,
    1554477: () => screen.width,
    1554502: () => screen.height,
    1554528: () => {
    ...
    1554982: a => __gx_check_cache(a ? x(v, a) :
        "", !0) ? 1 : 0,
    1555044: (a, b, c, d, e, f, g, h) => {
    ...
    1555141: () => {
        (function() {
            ...
            document.body.addEventListener(d, a, {
                once: !0
            })
        })()
    },
    ...
    1556424: (a, b, c, d) => {
        __gx_prepare_cache(c ? x(v, c) : "").then(e => {
            console.log("Prepare cache completed" +
                JSON.stringify(e));
            k.dynCall("vi", a, [b])
        }).catch(e => {
    ...
    1556704: () => {
        ...
        window.addEventListener("message", a => {
            const b = {
                Wk: k.cwrap("on_post_message_callback", "", ["string", "string"])
            };
            "string" === typeof a.data || a.data instanceof String ? b.Wk(a.data, a.origin) : b.Wk(JSON.stringify(a.data),
                a.origin)
        });
        window.parent.postMessage("gm_post_message_listener_setup_complete", "*")
    },
    1557421: a => __gx_check_cache(a ? x(v, a) : "", !1) ? 1 : 0,
    1557482: (a, b) => {
        g_pWadLoadCallback && g_pWadLoadCallback(a, b)
    },
    1557542: a => {
    ...
    1558349: () => window.matchMedia("(any-hover: none)").matches || window.matchMedia("(any-hover: hover) and (pointer: coarse)").matches || "undefined" != typeof window.oprt,
    1558522: (a, b, c, d, e, f, g) => {
        qa = a;
        ra = b;
        ua = c;
        va = d;
    ...
    1559314: a => confirm(a ? x(v, a) : "") ? 1 : 0,
    1559361: a => {
        alert(a ? x(v, a) : "")
    },
    1559391: () => {
        Pb("/_savedata");
        window.oprt && window.oprt.gameStorage ? Qb(GXMFS, "/_savedata") : Qb(K, "/_savedata");
        Nb(!0, function() {
    ...
    1560007: () => {
        ...
        if (window.PointerEvent ||
            window.navigator.pointerEnabled || window.navigator.msPointerEnabled) b = "pointerdown", c = "pointerup";
    ...
    1560978: () => null == da ? 0 : da.currentTime,
    1561056: () => null == da ? 0 : da.sampleRate,
    1561133: () => null == da ? 0 : da.destination.channelCount,
    1561222: (a,
        b, c, d, e, f) => {
    ...
    1564581: a => ea.length * a,
    1564667: () => null != ha && null != ka ? 1 : 0,
    1564780: () => "undefined" !== typeof AudioContext || "undefined" !== typeof webkitAudioContext ? !0 : !1,
    1564927: () => "undefined" !== typeof navigator.mediaDevices && "undefined" !== typeof navigator.mediaDevices.getUserMedia || "undefined" !==
        typeof navigator.webkitGetUserMedia ? !0 : !1,
    1565161: a => {
    ...
    1567374: (a, b, c, d) => {
        ...
        e.audio.Ui.onaudioprocess = function(f) {
            void 0 !== e && void 0 !== e.audio && (e.audio.Lk = f.outputBuffer, Ub("vi", c, [d]))
        };
        e.audio.Ui.connect(e.Ri.destination)
    },
    1567784: (a, b) => {
        for (var c = k.SDL2,
                d = c.capture.ek.numberOfChannels, e = 0; e < d; ++e) {
    ...
    1568869: a => {
        ...
        if (a) {
            ...
            void 0 !== b.capture.Ui && (b.capture.Ui.onaudioprocess = function() {}, b.capture.Ui.disconnect(), b.capture.Ui = void 0);
            void 0 !== b.capture.Tj && (b.capture.Tj.disconnect(), b.capture.Tj =
                void 0);
    ...
    1570041: (a, b, c) => {
        ...
        if (d.w !== a || d.h !== b || d.vl !== d.bj) d.image = d.bj.createImageData(a, b), d.w = a, d.h = b, d.vl = d.bj;
        a = d.image.data;
        b = c >> 2;
        var e = 0;
    ...
    1572651: () => window.innerWidth,
    1572681: () => window.innerHeight
};
